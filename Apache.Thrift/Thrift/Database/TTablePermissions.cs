...
{
    public class TTablePermissions : TBase
    {
        ...
        private bool _truncate_;
        private bool _alter_;
                ...
                while (true)
                {
                    ...
                    switch (field.ID)
                    {
                        ...
                        case 7:
                            if (field.Type == TType.Bool)
                            {
                                Truncate_ = await iprot.ReadBoolAsync(cancellationToken);
                            }
                            else
                            {
                                await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
                        ...
                        case 8:
                            if (field.Type == TType.Bool)
                            {
                                Alter_ = await iprot.ReadBoolAsync(cancellationToken);
                            }
                            else
                            {
                                await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
        ...
        public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var struc = new TStruct("TTablePermissions");
                ...
                if (isset.truncate_)
                {
                    field.Name = "truncate_";
                    field.Type = TType.Bool;
                    field.ID   = 7;
                    await oprot.WriteFieldBeginAsync(field, cancellationToken);
                    await oprot.WriteBoolAsync(Truncate_, cancellationToken);
                    await oprot.WriteFieldEndAsync(cancellationToken);
                }
                if (isset.alter_)
                {
                    ...
                    field.ID   = 8;
                    await oprot.WriteFieldBeginAsync(field, cancellationToken);
                    await oprot.WriteBoolAsync(Alter_, cancellationToken);
                    await oprot.WriteFieldEndAsync(cancellationToken);
                }
        ...
        {
            var other = that as TTablePermissions;
            ...
            return ((isset.create_   == other.isset.create_)   && ((!isset.create_)   || (System.Object.Equals(Create_,   other.Create_))))
                ...
                && ((isset.truncate_ == other.isset.truncate_) && ((!isset.truncate_) || (System.Object.Equals(Truncate_, other.Truncate_))))
                && ((isset.alter_    == other.isset.alter_)    && ((!isset.alter_)    || (System.Object.Equals(Alter_,    other.Alter_))));
        }
        ...
        public override int GetHashCode() {
            ...
            unchecked {
                ...
                if(isset.truncate_)
                    hashcode = (hashcode * 397) + Truncate_.GetHashCode();
                if(isset.alter_)
                    hashcode = (hashcode * 397) + Alter_.GetHashCode();
            }
            return hashcode;
        }
        ...
        {
            var  sb      = new StringBuilder("TTablePermissions(");
            bool __first = true;
            if (isset.create_)
            {
