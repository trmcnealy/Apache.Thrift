...
namespace Apache.Thrift.Transport.Server
{
    ...
    public class TTlsServerSocketTransport : TServerTransport
    {
        ...
        public TTlsServerSocketTransport(TcpListener                         listener,
        ...
        public TTlsServerSocketTransport(int                                 port,
                                         TConfiguration                      config,
                                         X509Certificate2                    certificate,
                                         RemoteCertificateValidationCallback clientCertValidator               = null,
                                         LocalCertificateSelectionCallback   localCertificateSelectionCallback = null,
        ...
        protected override async ValueTask<TTransport> AcceptImplementationAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                TTlsSocketTransport tTlsSocket = new TTlsSocketTransport(client,
                                                                         Configuration,
                                                                         _serverCertificate,
                                                                         true,
