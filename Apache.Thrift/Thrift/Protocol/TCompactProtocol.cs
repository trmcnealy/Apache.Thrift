...
namespace Apache.Thrift.Protocol
{
    ...
    public class TCompactProtocol : TProtocol
    {
        ...
        private static readonly TField StopField = new TField(string.Empty,
                                                              TType.Stop,
                                                              0);
                                                          ...
                                                          CancellationToken cancellationToken)
        {
            ...
            await Trans.WriteAsync(PreAllocatedBuffer,
                                   0,
                                   2,
                                   cancellationToken);

            Int32ToVarInt((uint)message.SeqID,
                          ref PreAllocatedVarInt);

            await Trans.WriteAsync(PreAllocatedVarInt.bytes,
                                   0,
                                   PreAllocatedVarInt.count,
                                   cancellationToken);
        ...
        private async Task WriteFieldBeginInternalAsync(TField            field,
                                                        byte              fieldType,
                                                        CancellationToken cancellationToken)
        {
                                                        ...
                                                        CancellationToken cancellationToken)
        {
            ...
            {
                await WriteFieldBeginInternalAsync(field,
                                                   NoTypeOverride,
                                                   cancellationToken);
            }
        }
        ...
        protected async Task WriteCollectionBeginAsync(TType             elemType,
                                                       int               size,
                                                       CancellationToken cancellationToken)
        {
            if(cancellationToken.IsCancellationRequested)
        ...
        public override async Task WriteListBeginAsync(TList             list,
                                                       CancellationToken cancellationToken)
        {
            await WriteCollectionBeginAsync(list.ElementType,
                                            list.Count,
                                            cancellationToken);
        }
                                                      ...
                                                      CancellationToken cancellationToken)
        {
            ...
            await WriteCollectionBeginAsync(set.ElementType,
                                            set.Count,
                                            cancellationToken);
        }
                                                  ...
                                                  CancellationToken cancellationToken)
        {
            ...
            */
            ...
            if(_booleanField != null)
            {
                ...
                await WriteFieldBeginInternalAsync(_booleanField.Value,
                                                   type,
                                                   cancellationToken);
        ...
        private static void Int32ToVarInt(uint       n,
                                          ref VarInt varint)
        {
        ...
        private static void Int64ToVarInt(ulong      n,
                                          ref VarInt varint)
        {
                                                 ...
                                                 CancellationToken cancellationToken)
        {
            ...
            Int64ToVarInt(LongToZigzag(i64),
                          ref PreAllocatedVarInt);
                                                    ...
                                                    CancellationToken cancellationToken)
        {
            ...
            BinaryPrimitives.WriteInt64LittleEndian(PreAllocatedBuffer,
                                                    ...
                                                    CancellationToken cancellationToken)
        {
            ...
            try
            {
                int numberOfBytes = Encoding.UTF8.GetBytes(str,
                                                           0,
                                                           str.Length,
                                                           buf,
                                                           0);

                Int32ToVarInt((uint)numberOfBytes,
                              ref PreAllocatedVarInt);
                                                    ...
                                                    CancellationToken cancellationToken)
        {
            ...
            Int32ToVarInt((uint)bytes.Length,
                          ref PreAllocatedVarInt);
        ...
        public override async ValueTask<TMessage> ReadMessageBeginAsync(CancellationToken cancellationToken)
        {
            ...
            return new TMessage(messageName,
                                (TMessageType)type,
                                seqid);
        }
        ...
        public override async ValueTask<TField> ReadFieldBeginAsync(CancellationToken cancellationToken)
        {
            ...
            TField field = new TField(string.Empty,
                                      ttype,
                                      fieldId);
        ...
        public override async ValueTask<TMap> ReadMapBeginAsync(CancellationToken cancellationToken)
        {
            ...
            */
            ...
            TMap map = new TMap(GetTType((byte)(keyAndValueType >> 4)),
        ...
        public override async ValueTask<string> ReadStringAsync(CancellationToken cancellationToken)
        {
            ...
            if(length < PreAllocatedBuffer.Length)
            {
                ...
                return Encoding.UTF8.GetString(PreAllocatedBuffer,
                                               0,
                                               length);
            }
