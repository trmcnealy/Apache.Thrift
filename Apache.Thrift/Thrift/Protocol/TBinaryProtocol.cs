...
namespace Apache.Thrift.Protocol
{
    ...
    public class TBinaryProtocol : TProtocol
    {
        ...
        public override async Task WriteFieldStopAsync(CancellationToken cancellationToken)
        {
            ...
            await WriteByteAsync((sbyte)TType.Stop,
                                 cancellationToken);
        }
                                                  ...
                                                  CancellationToken cancellationToken)
        {
            ...
            await WriteByteAsync(b ? (sbyte)1 : (sbyte)0,
                                 cancellationToken);
        }
                                                 ...
                                                 CancellationToken cancellationToken)
        {
            ...
            BinaryPrimitives.WriteInt16BigEndian(PreAllocatedBuffer,
                                                 i16);
                                                 ...
                                                 CancellationToken cancellationToken)
        {
            ...
            BinaryPrimitives.WriteInt32BigEndian(PreAllocatedBuffer,
                                                 i32);
                                                 ...
                                                 CancellationToken cancellationToken)
        {
            ...
            BinaryPrimitives.WriteInt64BigEndian(PreAllocatedBuffer,
                                                 i64);
                                                    ...
                                                    CancellationToken cancellationToken)
        {
            ...
            await WriteI64Async(BitConverter.DoubleToInt64Bits(d),
                                cancellationToken);
        }
                                                    ...
                                                    CancellationToken cancellationToken)
        {
            ...
            await WriteI32Async(bytes.Length,
                                cancellationToken);
        ...
        public override async ValueTask<TMessage> ReadMessageBeginAsync(CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                message.Name = size > 0
                                   ? await ReadStringBodyAsync(size,
                                                               cancellationToken)
                                   : string.Empty;
        ...
        public override async ValueTask<TField> ReadFieldBeginAsync(CancellationToken cancellationToken)
        {
            ...
            TType type = (TType)await ReadByteAsync(cancellationToken);
            ...
            return new TField
            {
                Type = type, ID = await ReadI16Async(cancellationToken)
            };
        }
        ...
        public override async ValueTask<TList> ReadListBeginAsync(CancellationToken cancellationToken)
        {
            ...
            {
                ElementType = (TType)await ReadByteAsync(cancellationToken), Count = await ReadI32Async(cancellationToken)
            };
        ...
        private async ValueTask<string> ReadStringBodyAsync(int               size,
                                                            CancellationToken cancellationToken)
        {
            if(cancellationToken.IsCancellationRequested)
            {
        ...
        public class Factory : TProtocolFactory
        {
            ...
            public Factory(bool strictRead,
                           bool strictWrite)
            {
                StrictRead  = strictRead;
                StrictWrite = strictWrite;
